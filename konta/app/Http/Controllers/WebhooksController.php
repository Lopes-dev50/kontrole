...
class WebhooksController extends Controller
{
    public function __invoke(Request $request)
    {
        ...
        $response = HTTP::get("https://api.mercadopago.com/v1/payments/$payment_id" . "?access_token=APP_USR-609000000000000-041921-9b145f3d7993cf775e952e1e57eb9a21-178883096");
