            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                     <!----------inicio------>
                      ...
                      <form action="{{ route('mbcontrole.update',['id' =>$enc->encriptar($item->id), 'mes' => $enc->encriptar(\Carbon\Carbon::parse($item->data)->format('m')), 'ano' => $enc->encriptar(\Carbon\Carbon::parse($item->data)->format('Y'))] ) }} " method="post"
                   ...
                   <div class="relative z-0 w-full mb-6 group">
                    <button type="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">ATUALIZAR
                       ...
                       <div class="relative z-0 w-full mb-6 group">
                        <a href="{{ route ('mbdestroy', ['id' =>$enc->encriptar($item->id), 'mes' => $enc->encriptar(\Carbon\Carbon::parse($item->data)->format('m')), 'ano' => $enc->encriptar(\Carbon\Carbon::parse($item->data)->format('Y'))])}}">
