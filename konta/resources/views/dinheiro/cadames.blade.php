                ...
                <div class="flex flex-row">
                    <div class="basis-1/4 pr-4">
                     <div class="max-w-sm p-6 bg-red-600 border border-red-200 rounded-lg shadow ">
                                   <h5 class="mb-2 text-1xl font-semibold tracking-tight text-gray-900 ">DESPESAS DO MÊS</h5>
                           <p class="mb-3 font-normal text-2xl text-gray-100 ">R$ {{$formatted = number_format($total_saida/100, 2, ',', '.')  }}</p>
                       </div>
                    </div>
                    <div class="basis-1/4 pr-4">
                        <div class="max-w-sm p-6 bg-green-600 border border-green-200 rounded-lg shadow  ">
                            <h5 class="mb-2 text-1xl font-semibold tracking-tight text-gray-900 ">RECEITAS DO MÊS</h5>
                               <p class="mb-3 font-normal text-2xl text-gray-100 ">R$ {{$formatted = number_format($total_entrada/100, 2, ',', '.')  }}</p>
                           </div>
                    </div>
                    <div class="basis-1/4"> <div class="basis-1/4">
                        <div class="max-w-sm p-6 bg-yellow-500 border border-blue-200 rounded-lg shadow ">
                             <h5 class="mb-2 text-1xl font-semibold tracking-tight text-gray-900 ">CAIXA DO MÊS</h5>
                                 @if( $saldo > 0  )
                                 <p class="mb-3 font-normal text-2xl text-gray-100 ">R$ {{$formatted = number_format($saldo/100, 2, ',', '.')  }}</p>    
                                 </div>
                                 @else
                                 <p class="mb-3 font-normal text-2xl text-red-400 ">R$ {{$formatted = number_format($saldo/100, 2, ',', '.')  }}</p>   
                                   </div>
                                @endif
                           </div>
                    </div>
...
<div class="basis-1/4 pl-4 pr-4"></div>
<div class="basis-1/2 ">
    <div class="flex flex-wrap -m-4">
                        ...
                        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                            ...
                            <tbody>
                                ...
                                <tr class="bg-black border-b dark:bg-black ">
                                    ...
                                    <td class="px-6 py-4">
                                        <a href="{{ route ('controle.pagar', ['id' =>$enc->encriptar($item->id), 'mes' =>$enc->encriptar( \Carbon\Carbon::parse($item->data)->format('m')),'ano' =>$enc->encriptar( \Carbon\Carbon::parse($item->data)->format('Y')) ])}}">
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="py-1 px-2 mr-2 bg-indigo-800 hover:bg-indigo-600 focus:ring-indigo-500 focus:ring-offset-indigo-200 text-white w-full transition ease-in duration-200 text-center text-sm font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2 rounded-lg" style="width: 100px; height: 30px;">
                                            <a href="{{ route ('controle.edit', ['id' =>$enc->encriptar($item->id), 'mes' => $enc->encriptar(\Carbon\Carbon::parse($item->data)->format('m'))])}}" >Editar</a>
                                          </div>
